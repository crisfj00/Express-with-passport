...
app.get('/github/callback', (req, res) => {
  ...
  axios({
    method: 'post',
    url: `https://github.com/login/oauth/access_token?client_id=${process.env.OAUTH2_CLIENT_ID}&client_secret=${process.env.OAUTH2_CLIENT_SECRET}&code=${requestToken}`,
